...
const AddExpenseBtn = () => {
    ...
    return (
        <>
            ...
            className='float-right text-center rounded-full  h-16 fixed bottom-16 md:right-12 bg-budget text-white md:w-auto md:px-4 xs:p-0 xs:w-16 xs:right-2'>
               <span className="xs:hidden md:inline">Ajouter une dépense</span> 
